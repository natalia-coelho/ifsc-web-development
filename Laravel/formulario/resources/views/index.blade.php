...
<body>
    <div class="container">
        <h1> Cadastro </h1>
        <form id="form" name="form" action="{{ route('confirmado') }}" method="post">
            {!! csrf_field() !!}  <!-- Mecanismo de proteção obrigatório em métodos post, sem ele dá erro na requisição!! -->
            <div class="row">
            ...
            <div class="dropdown">
                 <button class="btn btn-success" type="button"  onclick="confirma();" >
                    Salvar
                </button>
    ...
    <script>
        function confirma(){
            ...
            let confirma = confirm("Confirmar cadastro?");
            ...
            if (confirma) {                
                redirect('http://127.0.0.1:8000/formulario', 'post');
            } 
            else {
                redirect('http://127.0.0.1:8000/cancelado', 'post');
            }
